...
public class EmpleadoBiomini implements Serializable {
    ...
    public EmpleadoBiomini(Integer idEmpleado, String codInterno, String tipoDocumento, String numDocumento, String nombre,
