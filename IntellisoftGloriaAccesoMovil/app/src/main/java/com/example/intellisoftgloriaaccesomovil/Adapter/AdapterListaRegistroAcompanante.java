...
public class AdapterListaRegistroAcompanante extends RecyclerView.Adapter<AdapterListaRegistroAcompanante.MyViewHolder> {

    Context mContext;
    ArrayList<Acompañantes> listaAcompañante;

    public AdapterListaRegistroAcompanante(Context context, ArrayList<Acompañantes> listaAcompañante) {
    ...
    @Override
    public void onBindViewHolder(@NonNull AdapterListaRegistroAcompanante.MyViewHolder holder, int position) {

        holder.tv_name.setText(listaAcompañante.get(position).getNombres());
